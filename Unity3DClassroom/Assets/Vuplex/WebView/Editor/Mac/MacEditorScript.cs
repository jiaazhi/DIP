...
namespace Vuplex.WebView {
    ...
    class MacEditorScript {
        ...
        static MacEditorScript() {
            ...
            _executeBashCommand("xattr -d com.apple.quarantine " + MAC_PLUGIN_BUNDLE_PATH);
            ...
            foreach (var relativePath in binaryRelativePaths) {
                var path = Path.Combine(MAC_PLUGIN_BUNDLE_PATH, relativePath);
                _chmod("755 \"" + path + "\"");
            }
        }

        const string MAC_PLUGIN_BUNDLE_PATH = "Assets/Vuplex/WebView/Plugins/Mac/VuplexWebViewMac.bundle";
