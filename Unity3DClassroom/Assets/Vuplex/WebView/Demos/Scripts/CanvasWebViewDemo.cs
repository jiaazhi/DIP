    ...
    class CanvasWebViewDemo : MonoBehaviour {
        ...
        void Start() {
            ...
            _canvasWebViewPrefab.Initialized += (sender, e) => {
                ...
                _canvasWebViewPrefab.WebView.LoadProgressChanged += WebView_LoadProgressChanged;
            };
        ...
        void WebView_LoadProgressChanged(object sender, ProgressChangedEventArgs eventArgs) {
            ...
            if (eventArgs.Type == ProgressChangeType.Finished) {
                _canvasWebViewPrefab.WebView.PostMessage("{\"type\": \"greeting\", \"message\": \"Hello from C#!\"}");
            }
        }
    }
}
